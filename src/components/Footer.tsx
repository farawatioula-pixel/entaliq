...
export default function Footer() {
  return (
    <footer className="border-t border-neutral-800 bg-ink text-neutral-400">
      <div className="mx-auto max-w-7xl px-5 py-14 sm:px-8">
        ...
        <div className="mt-12 flex flex-col gap-4 border-t border-neutral-800 pt-6 text-xs sm:flex-row sm:items-center sm:justify-between">
