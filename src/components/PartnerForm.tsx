    ...
    <form onSubmit={handleSubmit} noValidate className="space-y-5">
      <div className="grid grid-cols-1 gap-5 sm:grid-cols-2">
        <div>
          ...
          <input
            ...
            name="name"
            autoComplete="name"
            className={`w-full rounded-sm border bg-surface px-4 py-3 text-[15px] text-white placeholder:text-neutral-300 focus:border-red ${
      ...
      <div>
        ...
        <textarea
          ...
          className="w-full rounded-sm border border-line bg-surface px-4 py-3 text-[15px] text-white placeholder:text-neutral-300 focus:border-red"
        />
      </div>
