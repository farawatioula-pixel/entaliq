    ...
    return (
      <div className="rounded-sm border border-line bg-paper p-8 text-center">
        ...
        <button
          type="button"
          onClick={onClose}
          className="mt-6 inline-flex items-center rounded-sm bg-surface border border-line px-6 py-2.5 text-sm font-semibold text-white hover:bg-line"
        >
          Done
        </button>
      </div>
    ...
    <form onSubmit={handleSubmit} noValidate className="space-y-5">
      ...
      <div className="flex items-center gap-3 pt-2">
        ...
        <button
          type="button"
          onClick={onClose}
          className="rounded-sm border border-line px-5 py-3.5 text-[15px] font-semibold text-neutral-300 hover:bg-paper"
        >
          Cancel
        </button>
      </div>
