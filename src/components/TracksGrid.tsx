          ...
          <div key={category} className="border border-line">
            ...
            >
              ...
              {items.slice(0, 1).map((track) => (
                <div
                  key={track.title}
                  className="flex flex-col gap-3 border-b border-line bg-white px-8 py-10 sm:border-b-0 sm:border-r last:sm:border-r-0"
                >
                  <p className="text-xs font-semibold uppercase tracking-widest text-red">
                    {track.category}
                  </p>
            ...
            {items.length > 1 && (
              ...
              >
                {items.slice(1).map((track, i) => (
                  <div
                    key={track.title}
                    className={`flex flex-col gap-3 border-line bg-white px-8 py-10 ${
