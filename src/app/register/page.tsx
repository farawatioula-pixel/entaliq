    ...
    <>
      ...
      <section className="mx-auto max-w-7xl px-5 py-20 sm:px-8">
        ...
        <div className="mt-8 grid grid-cols-1 gap-px overflow-hidden border border-line bg-line lg:grid-cols-2">
          <div className="bg-white px-8 py-10 sm:px-12 sm:py-14">
            ...
            <button
              ...
              className="mt-8 flex w-full items-center justify-between rounded-sm bg-ink px-6 py-4 text-[15px] font-semibold text-white transition-colors hover:bg-black"
            >
