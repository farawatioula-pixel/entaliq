...
export default function SignupPage() {
  ...
  if (done) {
    return (
      <main className="border-t-4 border-cyan bg-ink px-5 py-24 text-center sm:px-8">
        <h1 className="font-display text-3xl font-black text-fg">Check your email</h1>
        <p className="mx-auto mt-4 max-w-md text-[15px] text-neutral-300">
  ...
  return (
    <main className="border-t-4 border-cyan bg-ink px-5 py-20 sm:px-8">
      <div className="mx-auto max-w-sm">
        ...
        <h1 className="mt-3 font-display text-3xl font-black text-fg">Sign up</h1>
        <p className="mt-2 text-[15px] text-neutral-400">
          Set up your account, then list the services you offer.
        </p>
